...
def load_checkpoint_d(checkpoint_path, combd, sbd, optimizer=None, load_opt=1):
    ...
    def go(model, bkey):
        ...
        new_state_dict = {}
        for k, v in state_dict.items():  # 模型需要的shape # TODO Translate comments
            try:
                ...
                print("%s is not in the checkpoint", k)  # pretrain缺失的 # TODO Translate comments
                new_state_dict[k] = v  # 模型自带的随机值 # TODO Translate comments
        if hasattr(model, "module"):
